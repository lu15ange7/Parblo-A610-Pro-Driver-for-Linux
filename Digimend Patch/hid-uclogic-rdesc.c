...
/* fixed report descriptor of Parblo A610PRO interface 0 (stylus) */			
__u8 uclogic_rdesc_parblo_a610pro_fixed0_arr[] = {
	0x05, 0x0D,         /*  Usage Page (Digitizer),                 		*/
	0x09, 0x02,         /*  Usage (Pen),                            		*/
	0xA1, 0x01,         /*  Collection (Application),               		*/
	0x85, 0x07,         /*      Report ID (7),                      		*/
...
const size_t uclogic_rdesc_parblo_a610pro_fixed0_size =
			sizeof(uclogic_rdesc_parblo_a610pro_fixed0_arr);

__u8 uclogic_rdesc_parblo_a610pro_frame_arr[] = {
	0x05, 0x01,             /*  Usage Page (Desktop),                   */
	0x09, 0x07,             /*  Usage (Keypad),                         */
	0xA1, 0x01,             /*  Collection (Application),               */
	0x85, 0x06,             /*      Report ID (6),                      */
...
const size_t uclogic_rdesc_parblo_a610pro_frame_size =
			sizeof(uclogic_rdesc_parblo_a610pro_frame_arr);
